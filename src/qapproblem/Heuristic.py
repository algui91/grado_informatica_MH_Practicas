...
class Heuristic(object):
    ...
    def local_search(self, s, total_eval=10000, comp_ils=False):
            ...
            while i < tam and not improve_flag:
                if _DLB[i] == 0:
                    ...
                    if not improve_flag:
                        _DLB[i] = 1
                i += 1
        if total_eval != 10000 and not comp_ils : # If this is not 10000 we are calling LS with MA_10_*, return updated stop criteria
