...
class CompeticionTrayectorias(Heuristic):
    '''
    Implementation of the CompeticionTrayectorias algorithm
    
    CompeticionTrayectorias:
    ...
    def __init__(self, f_name, seed):
        ...
        Constructor
        '''
        super(CompeticionTrayectorias, self).__init__(f_name, seed)
    ...
    def find_solution(self):
        ...
        for _ in xrange(24):
            S_p = self.mutate(S) 
            S_pp, S_pp_cost = self.local_search(S_p, 4000, True) # 10000 for each LS, 100000 total
