...
\def\titulo{\textit{\fontsize{\titleSize}{50}\selectfont Meta Heurísticas}}
\def\carrera{\fontsize{\carreraSize}{50}\selectfont P1 - Búsqueda por trayectorias para el problema de la asignación cuadrática}
\def\escuela{\fontsize{\escuelaSize}{50}\selectfont Tercero Grado Ing. Informática}
\def\ciudad{\fontsize{\ciudadSize}{50}\selectfont Algoritmos considerados: Greedy, Búsqueda local y Enfriamiento simulado}
...
{\Large\textbf{Alejandro Alcalde Barros. 76625397 \\ Grupo 2 miércoles a las 17.30}}\\ % Author name
